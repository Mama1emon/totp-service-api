...
//        `when`(signUpService.signUp()).thenReturn(null)
//
...
//        val secret = "secret"
//
//        `when`(signUpService.signUp()).thenReturn(secret)
//
...
//        `when`(signUpService.signUp()).thenThrow(UserAlreadyExistException())
//
...
//        `when`(signUpService.signUp()).thenThrow(WeakPasswordException())
//
